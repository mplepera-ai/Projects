...
def design_narrative_intro_sections(project: Project, storage_ctx: Optional[Dict] = None) -> List[Dict]:
    ...
    wq_multiplier = ctx.get("wqImperviousMultiplierIn", 2.5)
    wq_paras = [
        ...
        f"is the greater of 1.0 inch of runoff over the total project area, or {wq_multiplier:g} inches "
        "of runoff over the impervious area, less any applicable dry detention or retention credit.",
    ]
